...
function createRentalAdd() {
  const location = getLocation(
    getRandomPositiveFloat(35.65, 35.7, 5),
    getRandomPositiveFloat(139.7, 139.8, 5)
  );

  return {
    author: getAuthor(getRandomPositiveInteger(1, COUNT)),
    offer: {
      title: 'Аренда жилья',
      address: `${location.lat}, ${location.lng}`,
      description:
        DESCRIPTION[getRandomPositiveInteger(0, DESCRIPTION.length - 1)],
      price: getRandomPositiveInteger(10000, 80000),
      type: APARTMENT_TYPES[
        getRandomPositiveInteger(0, APARTMENT_TYPES.length - 1)
      ],
      rooms: getRandomPositiveInteger(1, 5),
      guests: getRandomPositiveInteger(1, 8),
      checkin: `${getRandomPositiveInteger(12, 14)}:00`,
      checkout: `${getRandomPositiveInteger(12, 14)}:00`,
      features: shuffle(FEATURES).slice(
        0,
        getRandomPositiveInteger(1, FEATURES.length)
      ),
      photos: shuffle(PHOTOS).slice(
        0,
        getRandomPositiveInteger(1, PHOTOS.length)
      ),
    },
    location,
  };
